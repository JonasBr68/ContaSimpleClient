...
namespace ContasimpleAPI.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ApiListResultApiAccessApiModel. </summary>
        internal ApiListResultApiAccessApiModel()
        {
            Data = new ChangeTrackingList<ApiAccessApiModel>();
        }
        ...
        internal ApiListResultApiAccessApiModel(long? count, IReadOnlyList<ApiAccessApiModel> data, long? totalCount)
        {
            Count = count;
            Data = data;
        ...
        public IReadOnlyList<ApiAccessApiModel> Data { get; }
