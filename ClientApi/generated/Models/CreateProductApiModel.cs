...
{
    /// <summary> Defines the information for update a product. </summary>
    public partial class CreateProductApiModel
    {
        /// <summary> Initializes a new instance of CreateProductApiModel. </summary>
        /// <param name="name"> The product name. </param>
        /// <param name="price"> The product price. </param>
        /// <param name="vat"> The product VAT. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> is null. </exception>
        public CreateProductApiModel(string name, double price, double vat)
        {
            if (name == null)
            {
