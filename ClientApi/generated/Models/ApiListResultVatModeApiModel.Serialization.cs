...
namespace ContasimpleAPI.Models
{
    ...
    {
        internal static ApiListResultVatModeApiModel DeserializeApiListResultVatModeApiModel(JsonElement element)
        {
            Optional<long> count = default;
            Optional<IReadOnlyList<VatModeApiModel>> data = default;
            ...
            return new ApiListResultVatModeApiModel(Optional.ToNullable(count), Optional.ToList(data), Optional.ToNullable(totalCount));
        }

        internal static ApiListResultVatModeApiModel DeserializeApiListResultVatModeApiModel(XElement element)
        {
            long? count = default;
            long? totalCount = default;
            IReadOnlyList<VatModeApiModel> data = default;
            ...
            data = array;
            return new ApiListResultVatModeApiModel(count, data, totalCount);
        }
    }
}
