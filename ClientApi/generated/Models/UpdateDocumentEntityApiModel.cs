...
{
    /// <summary> Defines the information for update a document entity (the entity that is associated to an invoice, estimate or delivery note). </summary>
    public partial class UpdateDocumentEntityApiModel
    {
        /// <summary> Initializes a new instance of UpdateDocumentEntityApiModel. </summary>
        ...
        public UpdateDocumentEntityApiModel(string nif, string organization)
        {
            if (nif == null)
            {
