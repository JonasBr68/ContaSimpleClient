...
namespace ContasimpleAPI.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ApiListResultAppVersionApiModel. </summary>
        internal ApiListResultAppVersionApiModel()
        {
            Data = new ChangeTrackingList<AppVersionApiModel>();
        }
        ...
        internal ApiListResultAppVersionApiModel(long? count, IReadOnlyList<AppVersionApiModel> data, long? totalCount)
        {
            Count = count;
            Data = data;
        ...
        public IReadOnlyList<AppVersionApiModel> Data { get; }
