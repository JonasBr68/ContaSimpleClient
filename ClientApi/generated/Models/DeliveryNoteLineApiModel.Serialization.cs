...
namespace ContasimpleAPI.Models
{
    ...
    {
        internal static DeliveryNoteLineApiModel DeserializeDeliveryNoteLineApiModel(JsonElement element)
        {
            ...
            return new DeliveryNoteLineApiModel(concept.Value, detailedDescription.Value, Optional.ToNullable(discountPercentage), Optional.ToNullable(id), Optional.ToNullable(productId), productName.Value, productSku.Value, Optional.ToNullable(quantity), Optional.ToNullable(reAmount), Optional.ToNullable(rePercentage), Optional.ToNullable(totalTaxableAmount), Optional.ToNullable(unitTaxableAmount), Optional.ToNullable(vatAmount), Optional.ToNullable(vatPercentage));
        }

        internal static DeliveryNoteLineApiModel DeserializeDeliveryNoteLineApiModel(XElement element)
        {
            ...
            return new DeliveryNoteLineApiModel(concept, detailedDescription, discountPercentage, id, productId, productName, productSku, quantity, reAmount, rePercentage, totalTaxableAmount, unitTaxableAmount, vatAmount, vatPercentage);
        }
    }
}
