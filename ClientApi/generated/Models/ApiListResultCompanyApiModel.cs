...
namespace ContasimpleAPI.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ApiListResultCompanyApiModel. </summary>
        internal ApiListResultCompanyApiModel()
        {
            Data = new ChangeTrackingList<CompanyApiModel>();
        }
        ...
        internal ApiListResultCompanyApiModel(long? count, IReadOnlyList<CompanyApiModel> data, long? totalCount)
        {
            Count = count;
            Data = data;
        ...
        public IReadOnlyList<CompanyApiModel> Data { get; }
