...
namespace ContasimpleAPI.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ApiListResultNoteApiModel. </summary>
        internal ApiListResultNoteApiModel()
        {
            Data = new ChangeTrackingList<NoteApiModel>();
        }
        ...
        internal ApiListResultNoteApiModel(long? count, IReadOnlyList<NoteApiModel> data, long? totalCount)
        {
            Count = count;
            Data = data;
        ...
        public IReadOnlyList<NoteApiModel> Data { get; }
