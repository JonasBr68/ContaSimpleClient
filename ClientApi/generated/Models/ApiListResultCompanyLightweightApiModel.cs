...
namespace ContasimpleAPI.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ApiListResultCompanyLightweightApiModel. </summary>
        internal ApiListResultCompanyLightweightApiModel()
        {
            Data = new ChangeTrackingList<CompanyLightweightApiModel>();
        }
        ...
        internal ApiListResultCompanyLightweightApiModel(long? count, IReadOnlyList<CompanyLightweightApiModel> data, long? totalCount)
        {
            Count = count;
            Data = data;
        ...
        public IReadOnlyList<CompanyLightweightApiModel> Data { get; }
