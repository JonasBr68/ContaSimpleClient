...
namespace ContasimpleAPI.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ApiListResultEntityBankAccountApiModel. </summary>
        internal ApiListResultEntityBankAccountApiModel()
        {
            Data = new ChangeTrackingList<EntityBankAccountApiModel>();
        }
        ...
        internal ApiListResultEntityBankAccountApiModel(long? count, IReadOnlyList<EntityBankAccountApiModel> data, long? totalCount)
        {
            Count = count;
            Data = data;
        ...
        public IReadOnlyList<EntityBankAccountApiModel> Data { get; }
