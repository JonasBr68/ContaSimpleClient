...
namespace ContasimpleAPI.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ApiListResultPushToken. </summary>
        internal ApiListResultPushToken()
        {
            Data = new ChangeTrackingList<PushToken>();
        }
        ...
        internal ApiListResultPushToken(long? count, IReadOnlyList<PushToken> data, long? totalCount)
        {
            Count = count;
            Data = data;
        ...
        public IReadOnlyList<PushToken> Data { get; }
