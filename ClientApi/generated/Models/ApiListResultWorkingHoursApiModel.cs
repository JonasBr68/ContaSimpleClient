...
namespace ContasimpleAPI.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ApiListResultWorkingHoursApiModel. </summary>
        internal ApiListResultWorkingHoursApiModel()
        {
            Data = new ChangeTrackingList<WorkingHoursApiModel>();
        }
        ...
        internal ApiListResultWorkingHoursApiModel(long? count, IReadOnlyList<WorkingHoursApiModel> data, long? totalCount)
        {
            Count = count;
            Data = data;
        ...
        public IReadOnlyList<WorkingHoursApiModel> Data { get; }
