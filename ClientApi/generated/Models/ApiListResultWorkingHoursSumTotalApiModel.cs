...
namespace ContasimpleAPI.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ApiListResultWorkingHoursSumTotalApiModel. </summary>
        internal ApiListResultWorkingHoursSumTotalApiModel()
        {
            Data = new ChangeTrackingList<WorkingHoursSumTotalApiModel>();
        }
        ...
        internal ApiListResultWorkingHoursSumTotalApiModel(long? count, IReadOnlyList<WorkingHoursSumTotalApiModel> data, long? totalCount)
        {
            Count = count;
            Data = data;
        ...
        public IReadOnlyList<WorkingHoursSumTotalApiModel> Data { get; }
