...
namespace ContasimpleAPI.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ApiListResultMailPresetsApiModel. </summary>
        internal ApiListResultMailPresetsApiModel()
        {
            Data = new ChangeTrackingList<MailPresetsApiModel>();
        }
        ...
        internal ApiListResultMailPresetsApiModel(long? count, IReadOnlyList<MailPresetsApiModel> data, long? totalCount)
        {
            Count = count;
            Data = data;
        ...
        public IReadOnlyList<MailPresetsApiModel> Data { get; }
