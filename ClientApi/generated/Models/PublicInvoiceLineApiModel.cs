...
namespace ContasimpleAPI.Models
{
    ...
    public partial class PublicInvoiceLineApiModel
    {
        /// <summary> Initializes a new instance of PublicInvoiceLineApiModel. </summary>
        ...
        public PublicInvoiceLineApiModel(string concept, double quantity, double totalTaxableAmount, double unitTaxableAmount)
        {
            if (concept == null)
            {
