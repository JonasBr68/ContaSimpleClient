...
namespace ContasimpleAPI.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ApiListResultUserCompanyInfoApiModel. </summary>
        internal ApiListResultUserCompanyInfoApiModel()
        {
            Data = new ChangeTrackingList<UserCompanyInfoApiModel>();
        }
        ...
        internal ApiListResultUserCompanyInfoApiModel(long? count, IReadOnlyList<UserCompanyInfoApiModel> data, long? totalCount)
        {
            Count = count;
            Data = data;
        ...
        public IReadOnlyList<UserCompanyInfoApiModel> Data { get; }
