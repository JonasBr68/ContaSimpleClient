...
namespace ContasimpleAPI.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ApiListResultRetentionTypeApiModel. </summary>
        internal ApiListResultRetentionTypeApiModel()
        {
            Data = new ChangeTrackingList<RetentionTypeApiModel>();
        }
        ...
        internal ApiListResultRetentionTypeApiModel(long? count, IReadOnlyList<RetentionTypeApiModel> data, long? totalCount)
        {
            Count = count;
            Data = data;
        ...
        public IReadOnlyList<RetentionTypeApiModel> Data { get; }
