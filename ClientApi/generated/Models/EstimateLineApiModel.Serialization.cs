...
namespace ContasimpleAPI.Models
{
    ...
    {
        internal static EstimateLineApiModel DeserializeEstimateLineApiModel(JsonElement element)
        {
        ...
        internal static EstimateLineApiModel DeserializeEstimateLineApiModel(XElement element)
        {
            ...
            return new EstimateLineApiModel(concept, detailedDescription, discountPercentage, id, productId, productName, productSku, quantity, reAmount, rePercentage, totalTaxableAmount, unitTaxableAmount, vatAmount, vatPercentage);
        }
    }
}
