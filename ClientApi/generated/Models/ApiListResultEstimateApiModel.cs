...
namespace ContasimpleAPI.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ApiListResultEstimateApiModel. </summary>
        internal ApiListResultEstimateApiModel()
        {
            Data = new ChangeTrackingList<EstimateApiModel>();
        }
        ...
        internal ApiListResultEstimateApiModel(long? count, IReadOnlyList<EstimateApiModel> data, long? totalCount)
        {
            Count = count;
            Data = data;
        ...
        public IReadOnlyList<EstimateApiModel> Data { get; }
