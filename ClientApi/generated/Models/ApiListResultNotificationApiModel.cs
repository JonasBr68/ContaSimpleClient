...
namespace ContasimpleAPI.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ApiListResultNotificationApiModel. </summary>
        internal ApiListResultNotificationApiModel()
        {
            Data = new ChangeTrackingList<NotificationApiModel>();
        }
        ...
        internal ApiListResultNotificationApiModel(long? count, IReadOnlyList<NotificationApiModel> data, long? totalCount)
        {
            Count = count;
            Data = data;
        ...
        public IReadOnlyList<NotificationApiModel> Data { get; }
