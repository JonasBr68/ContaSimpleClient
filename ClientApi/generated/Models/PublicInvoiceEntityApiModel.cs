...
namespace ContasimpleAPI.Models
{
    ...
    public partial class PublicInvoiceEntityApiModel
    {
        /// <summary> Initializes a new instance of PublicInvoiceEntityApiModel. </summary>
        ...
        public PublicInvoiceEntityApiModel(string name, string nif)
        {
            if (name == null)
            {
