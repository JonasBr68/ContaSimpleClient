...
namespace ContasimpleAPI.Models
{
    ...
    {
        internal static ExpenseEntity DeserializeExpenseEntity(JsonElement element)
        {
            ...
            Optional<bool> isEmpty = default;
            Optional<string> nif = default;
            Optional<string> notes = default;
            Optional<string> oldTextCountry = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("county"))
                {
                    county = property.Value.GetString();
                    continue;
                }
                ...
                if (property.NameEquals("isEmpty"))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        property.ThrowNonNullablePropertyIsNull();
                    ...
                    isEmpty = property.Value.GetBoolean();
                    continue;
                }
                ...
                if (property.NameEquals("oldTextCountry"))
                {
                    oldTextCountry = property.Value.GetString();
                    continue;
                }
            ...
            return new ExpenseEntity(address.Value, Optional.ToNullable(companyId), country.Value, Optional.ToNullable(countryId), county.Value, customField1.Value, customField2.Value, email.Value, fax.Value, Optional.ToNullable(id), Optional.ToNullable(isEmpty), nif.Value, notes.Value, oldTextCountry.Value, organization.Value, phone.Value, postalCode.Value, province.Value, url.Value);
        }

        internal static ExpenseEntity DeserializeExpenseEntity(XElement element)
        {
            ...
            if (element.Element("county") is XElement countyElement)
            {
                county = (string)countyElement;
            }
            ...
            if (element.Element("isEmpty") is XElement isEmptyElement)
            {
                isEmpty = (bool?)isEmptyElement;
            }
            ...
            if (element.Element("oldTextCountry") is XElement oldTextCountryElement)
            {
                oldTextCountry = (string)oldTextCountryElement;
            }
            ...
            return new ExpenseEntity(address, companyId, country, countryId, county, customField1, customField2, email, fax, id, isEmpty, nif, notes, oldTextCountry, organization, phone, postalCode, province, url);
        }
    }
}
