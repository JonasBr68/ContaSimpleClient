...
namespace ContasimpleAPI.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ApiListResultCountryApiModel. </summary>
        internal ApiListResultCountryApiModel()
        {
            Data = new ChangeTrackingList<CountryApiModel>();
        }
        ...
        internal ApiListResultCountryApiModel(long? count, IReadOnlyList<CountryApiModel> data, long? totalCount)
        {
            Count = count;
            Data = data;
        ...
        public IReadOnlyList<CountryApiModel> Data { get; }
