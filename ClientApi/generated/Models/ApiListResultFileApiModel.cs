...
namespace ContasimpleAPI.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ApiListResultFileApiModel. </summary>
        internal ApiListResultFileApiModel()
        {
            Data = new ChangeTrackingList<FileApiModel>();
        }
        ...
        internal ApiListResultFileApiModel(long? count, IReadOnlyList<FileApiModel> data, long? totalCount)
        {
            Count = count;
            Data = data;
        ...
        public IReadOnlyList<FileApiModel> Data { get; }
