...
namespace ContasimpleAPI.Models
{
    ...
    public partial class PublicInvoiceConfigurationApiModel
    {
        /// <summary> Initializes a new instance of PublicInvoiceConfigurationApiModel. </summary>
        public PublicInvoiceConfigurationApiModel()
        {
        }

        /// <summary> The company identifier name. </summary>
        public string CompanyIdentifierName { get; set; }
        /// <summary> THe language to generate the invoice. </summary>
        public string Culture { get; set; }
        /// <summary> The currency used for the invoice. </summary>
