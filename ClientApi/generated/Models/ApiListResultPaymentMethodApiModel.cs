...
namespace ContasimpleAPI.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ApiListResultPaymentMethodApiModel. </summary>
        internal ApiListResultPaymentMethodApiModel()
        {
            Data = new ChangeTrackingList<PaymentMethodApiModel>();
        }
        ...
        internal ApiListResultPaymentMethodApiModel(long? count, IReadOnlyList<PaymentMethodApiModel> data, long? totalCount)
        {
            Count = count;
            Data = data;
        ...
        public IReadOnlyList<PaymentMethodApiModel> Data { get; }
