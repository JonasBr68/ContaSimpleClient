...
namespace ContasimpleAPI.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ApiListResultInvoiceFooterApiModel. </summary>
        internal ApiListResultInvoiceFooterApiModel()
        {
            Data = new ChangeTrackingList<InvoiceFooterApiModel>();
        }
        ...
        internal ApiListResultInvoiceFooterApiModel(long? count, IReadOnlyList<InvoiceFooterApiModel> data, long? totalCount)
        {
            Count = count;
            Data = data;
        ...
        public IReadOnlyList<InvoiceFooterApiModel> Data { get; }
